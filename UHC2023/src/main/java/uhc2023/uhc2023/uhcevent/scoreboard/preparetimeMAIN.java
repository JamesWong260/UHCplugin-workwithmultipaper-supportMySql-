...
public class preparetimeMAIN implements CommandExecutor {
    private UHC2023 plugin;

    public preparetimeMAIN(UHC2023 plugin) {
        this.plugin = plugin;
    }
